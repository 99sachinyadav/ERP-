  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.sucess) {
        localStorage.setItem("deanToken", response.data.adminToken);
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 shadow-2xl rounded-2xl overflow-hidden bg-white">
        <div className="p-8 md:p-10 bg-slate-800 text-white flex flex-col justify-between">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-semibold">Dean Access</h1>
            <p className="mt-3 text-slate-200 text-sm leading-relaxed">
              Review marks and attendance across sections with a consolidated, read-only
              oversight view.
            </p>
          </div>
          <div className="mt-10">
            <p className="text-xs text-slate-300">Need a different portal?</p>
        ...
        >
          <div>
            ...
            <p className="text-sm text-slate-500">
              Use your official dean credentials to continue.
            </p>
          </div>

          <label className="text-sm font-medium text-slate-700" htmlFor="dean-email">
            Email
          </label>
          <input
            id="dean-email"
          ...
          <label className="text-sm font-medium text-slate-700" htmlFor="dean-password">
            Password
          </label>
          <input
            id="dean-password"
